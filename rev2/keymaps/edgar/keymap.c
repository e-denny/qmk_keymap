...
static void render_navi(struct CharacterMatrix *matrix) {
  static char navi[][12] = {{0x58,0x59,0x11,0x73,0x74,0x75,0x76,0x77,0x78,0x68,0x69,0},
                            ...
                            {0x38,0x39,0x11,0xd3,0xd4,0xd5,0xd6,0xd7,0xd8,0x68,0x69,0}};
...
static void render_mous(struct CharacterMatrix *matrix) {
  static char mous[][12] = {{0x9e,0x9f,0x11,0x73,0x74,0x75,0x76,0x77,0x78,0x79,0x7a,0},
                            {0x9c,0x9d,0x11,0x93,0x94,0x95,0x96,0x97,0x98,0x99,0x9a,0},
                            {0x7e,0x7f,0x11,0xb3,0xb4,0xb5,0xb6,0xb7,0xb8,0xb9,0xba,0},
                            {0x7c,0x7d,0x11,0xd3,0xd4,0xd5,0xd6,0xd7,0xd8,0xd9,0xda,0}};
...
static void render_medi(struct CharacterMatrix *matrix) {
  static char medi[][6] = {{0x58,0x59,0x11,0x79,0x7a,0},
                           {0xbe,0xbf,0x11,0x0f,0x10,0},
                           {0xbc,0xbd,0x11,0x2f,0x30,0},
                           {0x7c,0x7d,0x11,0x4f,0x50,0}};
  matrix_write(matrix, medi[0]);
  matrix_write_P(matrix, PSTR("\n"));
  matrix_write(matrix, medi[1]);
  matrix_write_P(matrix, PSTR("\n"));
  matrix_write(matrix, medi[2]);
  matrix_write_P(matrix, PSTR("\n"));
  matrix_write(matrix, medi[3]);
}
